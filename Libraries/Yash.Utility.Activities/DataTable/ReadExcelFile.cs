...
namespace Yash.Utility.Activities.DataTable
{
    ...
    public class ReadExcelFile : CodedWorkflow
    {
        ...
        /// </summary>
        /// <param name="in_str_FilePath">The path of the Excel file to read.</param>
        ...
        public DataSet Execute(string in_str_FilePath = "Data\\Config.xlsx")
        {
            ...
            if (!File.Exists(in_str_FilePath)) throw new FileNotFoundException($"File not found {in_str_FilePath}");
