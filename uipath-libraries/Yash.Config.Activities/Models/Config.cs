...
/// <summary>
    ...
    public class Config : DynamicObject, ISerializable
    {
        /// <summary>
        ...
        public override bool TryGetMember(GetMemberBinder binder, out object result)
        {
            ...
            if (typeof(Config).IsAssignableFrom(property.PropertyType))
            {
                if (!Data.ContainsKey(propertyName))
                {
                    var nestedObject = Activator.CreateInstance(property.PropertyType) as Config;
        ...
        public override bool TrySetMember(SetMemberBinder binder, object value)
        {
            ...
            if (typeof(Config).IsAssignableFrom(property.PropertyType))
            {
                if (value is Config nestedObject)
                {
                    Data[propertyName] = nestedObject;
                    return true;
                }
