...
namespace Yash.Utility.Activities.Table
{
    ...
    public class ReadCSVTable : CodedWorkflow
    {
        ...
        [Workflow]
        public DataTable Execute(string in_str_FilePath, string in_str_TableName)
        {
            ...
            Log($"CSV successfully read: {DataTable.Columns.Count} columns, {DataTable.Rows.Count} rows", LogLevel.Trace);
            return DataTable;
        }
