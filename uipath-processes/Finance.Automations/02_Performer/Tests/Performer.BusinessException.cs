...
namespace Finance.Automations._02_Performer.Tests
{
    ...
    {
        public override string Id { get; set; } = "Performer.BusinessException";
        public override string ConfigPath { get; set; } = "Data\\Config.xlsx";
        public override string ExpectedExceptionMessage { get; set; } = ""; // Business exceptions are handled, not thrown

        /// <summary>
        /// Executes the Performer workflow test for business exception scenario.
        /// </summary>
        [TestCase]
        public new void Execute()
        {
            ...
            filter = filter.BySubject(FilterStringOperator.Contains, "[Performer] Business Rule Exception - Transaction");
